...
class CashCreateInvoiceByServiceRequestCustom
{
     ...
     */
    public function __construct($serviceName, $cardForbidden, $userEmail, $userPhone, $referenceId, $backUrl, $requestUrl, $addInfo, $amount, $deathDate, $serviceType, $description, $orderNumber)
    {
    ...
    /**
     * @param string $serviceName
     * @return \Sakhnovkrg\Wooppay\WSDL\CashCreateInvoiceByServiceRequest
     */
